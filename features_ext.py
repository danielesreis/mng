...
feature_names	= [ 'mean_R', 'mean_G', 'mean_B', 'mean_H', 'mean_S', 'mean_V', 'mean_L', 'mean_a', 'mean_b', 'RG_rate', 'RB_rate', \
					...
					'equator_stalk_B_diff', 'apex_stalk_B_diff', 'bcd', 'cd', 'dd', 'n_pixels', 'area', 'diameter']
...
for seg_folder in folders:
	...
	for img_name in img_names:
		...
		dominant_HSV										= ft.dominant_HSV_channel(HSV_img)
		...
		cd  												= ft.box_correlation_dimension(RGB_img)
		dd  												= ft.box_dilation_dimension(RGB_img)
		n_pixels											= ft.num_pixels(RGB_img)
		area												= ft.estimated_area(RGB_img)
		diameter											= ft.estimated_diameter(RGB_img)
